  ...
  <form action="contact.php" method="post" class="needs-validation modern-form" novalidate>
    <div class="row g-4">
      ...
      <div class="col-md-6">
        ...
        <input type="tel" class="form-control" id="phone" name="phone" placeholder="+1234567890" pattern="[0-9+ ]{8,15}" required>
      ...
      <div class="col-12">
        ...
        <textarea class="form-control" id="subject" name="subject" rows="5" placeholder="Write your message here..." required></textarea>
        <div class="invalid-feedback">Please enter a message.</div>
      </div>

      <!-- Submit -->
      <div class="col-12 mt-4">
        <button type="submit" name="submit" class="btn-modern btn btn-primary">Send Message</button>
      </div>
    </div>
  </form>

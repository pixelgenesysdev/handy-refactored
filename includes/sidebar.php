...
<aside id="sidebar" class="sidebar col-md-2">
  ...
  <nav class="menu">
    ...
    <a id="nav-btn" class="btn-sidebar side-menu <?php echo ($currentPage == 'user_setting.php') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>pages/user_setting">
       <img src="<?php echo SITE_URL; ?>assets/images/sidebar-icons/user_setting.png" alt="User Setting" /><span>User Setting</span>
    </a>
    ...
    <a id="nav-btn" class="btn-sidebar side-menu <?php echo ($currentPage == 'allbookings.php') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>pages/allbookings">
      <img src="<?php echo SITE_URL; ?>assets/images/sidebar-icons/history.png" alt="VoteNow" /><span>History of Bookings</span>
    </a>

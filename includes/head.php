...
<!-- Row start -->
    <div class="d-flex col-md-12" style="min-height: 100vh;">
        ...
        <div id="main-box" class="col-md-10">
            <!-- main box start -->
            <div class="innermain-box" style="background-color: #fff; padding: 0px 0; margin: 20px; border-radius: 25px; height: calc(100vh - 50px);overflow-y: auto;overflow-x: hidden;">
